...
public class Principal {
	...
	public static void main(String[] args) {
		...
		SimpleDateFormat formatadorData = new SimpleDateFormat("dd/MM/yyyy");	// FORMATAR A DATA
		SimpleDateFormat formatadorHora = new SimpleDateFormat("HH:mm"); 		// FORMATAR A HORA
							...
							case 3:
								...
								do {
									if (funcionarioDAO.buscarFun(cartAux) != null) {
										...
										cartAux2 = f2.getCarteiraTrab();//testar a nova key
						...
						do {
							...
							case 3:
								...
								do {
									...
									if (cliDAO.buscar(CPFaux1) != null) {
										System.out.println("Digite o CPF1");
										
										c1.setCpf(teclado.nextLine());
										CPFaux2 = c1.getCpf();//testar a nova key
										System.out.println((CPFaux2.equals(CPFaux1)));
										
										if(cliDAO.buscar(CPFaux2) == null || CPFaux2.equals(CPFaux1)) {
			...
			case 3:
				...
				do {
					...
					case 4:
						...
						teclado.nextLine();
						agendamentoAux = agendamentoDAO.BuscarAgendamento(teclado.nextLong());

						System.out.println("\t\tCODIGO\n\t" + agendamentoAux.getCodigo());
						System.out.println("\nDATA: " + agendamentoAux.getData());
						System.out.println("HORA:  " +  agendamentoAux.getHora());
						System.out.println("CPF CLIENTE: " + agendamentoAux.getCliente().getCpf());
						System.out.println("EMAIL CLIENTE: " + agendamentoAux.getCliente().getEmail());
						System.out.println("NUMERO CLIENTEs: " +  agendamentoAux.getCliente().getNumero());
						
						RelatorioDeServicos = agendaServicoDAO.ServicosDeUmAgendamento(agendamentoAux.getCodigo()	);//recebendo um arraylist
						
						for(int j = 0; j <RelatorioDeServicos.size() ;j++) {
							
							System.out.println("SERVIÇO " + j +": "+ RelatorioDeServicos.get(j).getTipo());// NOME DO SERVIÇO
						}
